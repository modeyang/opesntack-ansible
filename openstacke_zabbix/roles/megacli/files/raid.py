...
def disk_status(disk_array, disk_id):
    for disk in disk_array:
        if int(disk.dev_id) == int(disk_id):
...
if __name__ == '__main__':
    ...
    if command == 'pd_discovery':
        ...
        print disk_status(disk_array, args.pop())
    elif command == 'amount':
        print disk_amount(disk_array)
